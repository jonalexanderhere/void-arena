    ...
    <div className="min-h-screen bg-[#050816] text-white flex flex-col items-center justify-center p-6 relative overflow-hidden">
      ...
      >
        <div className="flex flex-col items-center space-y-2">
          ...
          <h1 className="text-2xl font-black italic uppercase italic tracking-tight">New Recruit</h1>
          <p className="text-zinc-500 text-sm font-medium uppercase tracking-widest text-center">Join the elite ranks of cybersecurity competitors.</p>
        </div>
        ...
        <div className="glass-card p-8 space-y-6 border-white/10">
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-[10px] font-bold uppercase tracking-widest">
              <span className="bg-[#050816] px-4 text-zinc-500">Fast Track</span>
            </div>
          </div>

          <div className="flex gap-4">
            <button className="w-full flex items-center justify-center gap-3 px-6 py-4 bg-white hover:bg-zinc-200 transition-colors font-black uppercase tracking-widest text-[11px] text-black">
              <span className="w-5 h-5 flex items-center justify-center">
                <svg viewBox="0 0 24 24" className="w-5 h-5"><path d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z" fill="#4285F4"/><path d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z" fill="#34A853"/><path d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.93l3.66-2.84z" fill="#FBBC05"/><path d="M12 5.38c1.62 0 3.06.56 4.21 1.66l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.47 2.18 7.07l3.66 2.84c.87-2.6 3.3-4.53 12-4.53z" fill="#EA4335"/></svg>
              </span>
              Join with Google
            </button>
          </div>
        ...
        <p className="text-center text-[10px] font-bold uppercase tracking-[0.2em] text-zinc-500">
          Already a member? <Link href="/login" className="text-primary hover:underline">Identification</Link>
        </p>
      </motion.div>
    </div>
  );
